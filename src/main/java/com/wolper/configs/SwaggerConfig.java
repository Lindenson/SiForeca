...
public class SwaggerConfig {
    ...
    private final String title = "SiForeca Open API";
    private final String description = "SiForeca";
    private final String version = "1.0";
    private final String globalHeader = "Authorization";
    ...
    public GroupedOpenApi publicApi() {
		...
		.group(group)
                .packagesToScan("com.wolper.controllers.swagger")
    ...
    private OperationCustomizer globalHeaderAdder() {
        return (operation, handlerMethod) -> {
            Parameter customHeader = new Parameter().in(ParameterIn.HEADER.toString())
                    .name(globalHeader).schema(new StringSchema()).required(false);
