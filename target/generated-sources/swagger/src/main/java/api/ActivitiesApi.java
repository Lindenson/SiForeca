...
public interface ActivitiesApi {
    ...
    @Operation(summary = "List of activities", description = "List of all activities in a database", tags={ "info" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<CodeAndName>> getActivities(@Parameter(in = ParameterIn.HEADER, description = "Interface" ,schema=@Schema()) @RequestHeader(value="Content-Language", required=false) String contentLanguage);
