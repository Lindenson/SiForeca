...
public interface CountriesApi {
    ...
    @Operation(summary = "List of countries", description = "List of all countries in a database", tags={ "country" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<CodeAndName>> getCountrs(@Parameter(in = ParameterIn.HEADER, description = "Interface" ,schema=@Schema()) @RequestHeader(value="Content-Language", required=false) String contentLanguage);
